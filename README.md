...
<br>
S = Enables the selection of the starting tile. When toggled on, the tile you select will set it as the starting point. (Only one tile can be the starting point. If selecting another tile while a start point was already set, the starting point will be replaced with the new one.)
<br>
